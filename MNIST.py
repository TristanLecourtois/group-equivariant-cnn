...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = P4ConvZ2(1, 10, kernel_size=3)  # 1 channel for MNIST
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        np.save('./results/acc_train_gcnn.npy', np.array(train_accuracy))
        ...
        np.save('./results/acc_val_gcnn.npy', np.array(val_accuracy))
        
        torch.save(model.state_dict(), "model_gcnn_mnist.pth")
